  ...
  #      grammar_12_uni1[i] = 0
   #     grammar_12_uni2[i] = 0
    ...
    for i in range(code_3rd.count):
        ...
        grammar_12_uni1.append((code_3rd.uni_data[i] - 44032) // 588)  # 초성
        grammar_12_uni2.append(((code_3rd.uni_data[i] - 44032) % 588) // 28)  # 중성
        grammar_12_uni3.append(((code_3rd.uni_data[i] - 44032) % 588) % 28)  # 종성


    #print(grammar_12_uni[a]) ###
    #print(grammar_12_uni1[a])
    #print(grammar_12_uni2[a])
    #print(grammar_12_uni3[a])
    ...
    elif 45208 <= grammar_12_uni[a] <= 45235:
